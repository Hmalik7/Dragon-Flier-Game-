...
public class DragonFlier2
{
    ...
    private class GamePane extends JPanel {
        /**creating message box instance to display the instruction */
        ...
        long startTime;
        private int instructionStartTime=0;
        int instructFlag;
        ...
        private void initialize(){
            ...
            //initializating the message box width, height and location 
           ...
           int msg_x, msg_y; 
            ...
            str = "GAME Rules: You are a mighty dragon flying around to eat eggs till they are ripe. If you eat them before they are ripe you will lose health. The egss will be white and time of ripe will be blue. But Watch out there are scray creatures roaming around that can attack you. But don't worry you can spit a fireball at them but it has a time window to spit again. If you take too much time those creatures are born from those same eggs. Wait remember you need time to recharge your fireball. Currently there are twelve eggs so you can gain up to 12 points.";
  
            System.out.print("Inside the dragon file instruction flag "+ this.instructFlag);
            this.msgBox = new MessageBox(dragon, FRAME_HEIGHT * 80/100, FRAME_WIDTH * 1/3, Color.YELLOW, Color.BLACK, msg_x, msg_y, str, instructFlag); 
            ...
            //this.instructionStartTime = 10*1000;
            ...
            /**
             * By pressing I you can view rules and the guidebook for this game and learn about things you need to survive this
             */
            addKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_I, 0, true), "I pressed: showing the rules", 
                                                                                new I_Action(msgBox));   
        ...
        protected void paintComponent(Graphics g) {
            ...
            //modified code for using the arrayList
            Egg thisEgg;
            for(int i = 0;i<eggList.count();i++)
            {
                thisEgg = eggList.get(i);
                thisEgg.draw(g);
                /**
                 * this is to draw eggs and their count in the game
                 */
            }
            this.dragon.draw(g);
            this.msgBox.draw(g);
            //displayMessageBoxTime(g);
    ...
    public class I_Action extends AbstractAction {
        GamePane gamePane;
        private MessageBox msgBox;
        public I_Action(MessageBox m){
            this.msgBox = m;
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            System.out.println("By tying I, you have opened up the guidebook!");
          
            msgBox.setInstructionFlag();
